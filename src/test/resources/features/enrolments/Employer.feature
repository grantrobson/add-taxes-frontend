...
@zap
  ...
  Scenario: Update pensions journey, no Scheme Practitioner ID
    Given I login as an Organisation with NO enrolments
    And I navigate to the employer page
  ...
  Scenario: Update pensions journey, yes Scheme Practitioner ID and activation token
    Given I login as an Organisation with NO enrolments
    And I navigate to the employer page
    Then I select pension and click continue
    And I click Yes button and continue
  ...
  Scenario: Update pensions journey, yes Scheme Practitioner ID No activation token
    Given I login as an Organisation with NO enrolments
    And I navigate to the employer page
    Then I select pension and click continue
    And I click Yes button and continue

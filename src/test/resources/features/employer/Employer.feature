...
Feature: Construction Industry Team
  ...
  Scenario: Yes I do need to stop acting as a pension scheme administrator
    ...
    And I navigate to the http://localhost:9730/business-account/deenrol/psa/how-to-stop-psa URL
  ...
  Scenario: Yes, My business stopped employing people
    ...
    And I navigate to the http://localhost:9730/business-account/deenrol/epaye/how-to-stop-paye URL
    And I click Yes button and continue
  ...
  Scenario: Yes, I have stopped trading as a contractor or subcontractor
    ...
    And I navigate to the http://localhost:9730/business-account/deenrol/cis/how-to-stop-cis URL
    And I click Yes button and continue
